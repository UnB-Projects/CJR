...
SELECT UPPER(empregado.nome) FROM empresa.empregado;
...
SELECT empregado.nome FROM empresa.empregado
WHERE empregado.datanasc BETWEEN '1950-01-01' AND '1970-01-01';
...
-- Dica: use DISTINCT.
SELECT DISTINCT empregado.codemp FROM empresa.empregado
JOIN empresa.trabalhaem
ON empregado.codemp = trabalhaem.codemp
